                  ...
                  child: Column(
                    ...
                    children: [
                      ListTile(
                        ...
                        title: Text(items[index].title,style: TextStyle(fontSize: 14),),
                        subtitle: items[index].flag?null:Text(getFixedString(items[index].description, 45),style: TextStyle(fontSize: 12,color: Colors.blueGrey),),
                      ...
                      Visibility(
                        ...
                        child: Padding(
                          ...
                          child: Text(items[index].description,textAlign: TextAlign.justify,style:const TextStyle(color: Colors.blueGrey,fontSize: 12),),
                        ),
                      ),
                    ],
                  ),
