...
class ContactData {
  ...
  static List<ContactCarousel> contactSliderData(){
    List<ContactCarousel> list=[
       ContactCarousel(image: "https://cdn0.iconfinder.com/data/icons/ui-interface-7/128/Email.png", title: "Drop us a Line"),
       ContactCarousel(image: "https://cdn3.iconfinder.com/data/icons/map-and-navigation-98/128/destination_location_destination_route_location_navigation_map.png", title: "Watch Our Location G-Map"),
       ContactCarousel(image: "https://cdn2.iconfinder.com/data/icons/3d-designer-thinking/128/Website.png", title: "For More Details Visit Our Site")
    ];
    return list ;
  }
}
